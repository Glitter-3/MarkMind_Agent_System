...
class Database:
    ...
    def init_schema(self):
        ...
        self.conn.query(
            ...
            DEFINE FIELD IF NOT EXISTS embedding ON TABLE concept TYPE array<float, 1536>;
            DEFINE INDEX IF NOT EXISTS concept_embedding ON TABLE concept FIELDS embedding HNSW DIMENSION 1536 DIST COSINE TYPE F32;
        """
        )
        ...
        self.conn.query(
            ...
            DEFINE FIELD IF NOT EXISTS embedding ON TABLE chunk TYPE array<float, 1536>;
            DEFINE FIELD IF NOT EXISTS source ON TABLE chunk TYPE record<doc>;
            DEFINE INDEX IF NOT EXISTS chunk_embedding ON TABLE chunk FIELDS embedding HNSW DIMENSION 1536 DIST COSINE TYPE F32;
        """
        )
